...
//*/
	...
	function GetRedirectURL(){
		...
		//echo $this->URLs['openid_server'] . "?". $this->array2url($params);
		//die();
	...
	function ValidateWithServer(){
		...
		for ($i=0; $i<count($arr_signed); $i++){
			...
			$s2 = str_replace('sreg_','', $arr_signed[$i]);
